...
// ── Input formatter (reuse fmt-price) ────────────────────────────────────────
...
function storeCapital() {
    ...
    axios.post('{{ route('capital.store') }}', payload)
        .then(res => {
            showSuccess('Berhasil', res.data.message || 'Modal berhasil ditambahkan');
            closeCreateModal();
...
function updateCapital() {
    ...
    axios.put(`/capital/${editId}`, payload)
        .then(res => {
            showSuccess('Berhasil', res.data.message || 'Modal berhasil diupdate');
            closeEditModal();
            table.ajax.reload(null, false);
        })
        .catch(err => {
