<div class="modal-overlay" id="createModal">
    <div class="modal-box">
        <div class="modal-header">
            <h3 class="modal-title">Tambah Transaksi Petty Cash</h3>
        ...
        <form id="createForm" onsubmit="return false;">
            <div class="modal-body">
                <div class="form-grid">
                    <div class="form-group full">
                        ...
                        <select name="petty_cash_id" id="createPettyCashSelect" class="form-select">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="storeTrx()">
