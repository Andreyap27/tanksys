<div class="modal-overlay" id="createModal">
    <div class="modal-box">
            ...
            <form id="createForm" onsubmit="return false;">
                <div class="form-grid">
                    <div class="form-group full">
                        ...
                        <select name="kapal_id" id="createKapalSelect" class="form-select">
                    ...
                    <div class="form-group full">
                        ...
                        <div style="display:flex;gap:0.5rem;align-items:flex-start;">
                            <select id="createVendorSelect" name="vendor" class="form-select" style="flex:1;min-width:0;">
                                <option value=""></option>
                            </select>
                            <button type="button" class="btn btn-primary" style="flex-shrink:0;padding:0.5rem 0.65rem;"
                                onclick="openQuickVendorModal('create')" title="Tambah Vendor Baru">
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-primary" data-save-btn onclick="storePurchase()">
