@extends('layouts.app')
@section('title', 'Laporan Sale - Trash')
@section('content')

@php
$pageTitle = 'Total Sale (Trash)';
$months = [
...
<div class="card">
    <div class="card-header">
        <div class="card-title">Total Sale (Trash)</div>
    </div>
...
@push('scripts')
<script>
    const basePrintUrl = '{{ route('report.print', ['section' => 'sale','year' => $year]) }}&trash=1';
